    ...
    <section className="relative bg-gradient-to-b from-brand-bg via-sky-50 to-white py-24 md:py-36 overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="hero-anim-4 flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="/posts/"
            className="inline-block bg-brand text-white px-8 py-3.5 rounded-xl hover:bg-brand-dark transition-all text-center font-bold shadow-lg shadow-brand/20 hover:-translate-y-0.5"
          >
            글 읽으러 가기
          </a>
          <a
            ...
            className="inline-block bg-white text-gray-700 px-8 py-3.5 rounded-xl border border-gray-200 hover:border-brand hover:text-brand transition-all text-center font-bold hover:-translate-y-0.5"
          >
            네이버 블로그
          </a>
        </div>
